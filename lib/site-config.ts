...
export const siteConfig = {
  ...
  hero: {
    ...
    emoji: "💛",
    subtitle:
      "Cada flor amarilla que veo me recuerda a vos. Este pequeño rincón es para decirte, una vez más, cuánto te quiero.",
  },

  letter: {
    heading: "Una carta para vos",
    // Podés escribir varios párrafos separados por elementos del arreglo
    paragraphs: [
      ...
      "Gracias por tu risa, por tu paciencia, por cada momento compartido. Sos mi persona favorita en este mundo entero.",
    ],
  ...
  song: {
    ...
    // Colocá tu archivo de audio en /public/audio/flores-amarillas.mp3
